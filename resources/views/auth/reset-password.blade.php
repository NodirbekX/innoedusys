...
<head>
    ...
    <title>{{ __("Yangi parol o'rnatish") }} - InnoEduSys</title>
    ...
    <div class="w-full max-w-md rounded-2xl p-8 shadow-2xl animate-[fadeInUp_0.8s_ease-out]
        ...
        <div class="text-center mb-8 animate-[float_3s_ease-in-out_infinite]">
            ...
            <h1 class="text-3xl font-bold tracking-tight animate-[fadeInUp_0.6s_ease-out_0.2s_both]
                       text-slate-800 dark:text-white">{{ __("Yangi parol o'rnatish") }}</h1>
            <p class="text-sm animate-[fadeInUp_0.6s_ease-out_0.4s_both]
                      text-slate-600 dark:text-indigo-300/80">{{ __('Kuchli parol tanlang') }}</p>
        </div>
        ...
        <div class="mb-6 p-4 rounded-lg text-sm flex items-start gap-3 animate-[fadeInUp_0.6s_ease-out_0.5s_both]
            ...
            <span class="text-indigo-500 dark:text-indigo-400 flex-shrink-0 mt-0.5">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 5.25a3 3 0 013 3m3 0a6 6 0 01-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H8.25v2.25H6v2.25H2.25v-2.818c0-.597.237-1.17.659-1.591l6.499-6.499c.404-.404.527-1 .43-1.563A6 6 0 1121.75 8.25z" /></svg>
            </span>
            <span>{{ __("Hisobingiz uchun yangi xavfsiz parol yarating. Parolingiz kamida 8 ta belgidan iborat bo'lishi kerak.") }}</span>
        </div>
        ...
        <form method="POST" action="{{ route('password.store') }}">
            ...
            <!-- Email Address -->
            <div class="mb-5 animate-[fadeInUp_0.6s_ease-out_0.6s_both]">
                ...
                <div class="relative">
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email', $request->email) }}" required autofocus autocomplete="username" placeholder="{{ __('your@email.com') }}"
            ...
            <!-- Password -->
            <div class="mb-5 animate-[fadeInUp_0.6s_ease-out_0.7s_both]">
                <label for="password" class="block text-sm font-medium mb-2
                                             text-slate-700 dark:text-slate-300">{{ __('Yangi parol') }}</label>
                <div class="relative">
                    <span class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-indigo-500 dark:text-indigo-400">
                ...
                <div class="mt-2 text-xs text-slate-500 dark:text-slate-400 pl-10">
                    {{ __('Kuchli parol: harflar, raqamlar va maxsus belgilar') }}
                </div>
            ...
            <!-- Confirm Password -->
            <div class="mb-6 animate-[fadeInUp_0.6s_ease-out_0.8s_both]">
            ...
            <button type="submit" class="w-full py-3 px-6 rounded-lg text-white font-bold text-base transition-all duration-300 shadow-lg animate-[fadeInUp_0.6s_ease-out_0.9s_both] flex items-center justify-center gap-2
