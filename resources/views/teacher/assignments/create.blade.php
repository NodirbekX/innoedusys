...
@section('content')
    <div class="max-w-4xl mx-auto p-6">
        <h2 class="text-3xl font-extrabold mb-6 tracking-wide
                   text-cyan-600 dark:text-cyan-300">{{ __('📝 Topshiriq Yaratish') }}</h2>
        ...
        <form method="POST" action="{{ route('teacher.assignments.store') }}" enctype="multipart/form-data"
            ...
            <div class="mb-4 p-3 rounded-lg
                ...
                <p class="text-sm mb-1 text-slate-500 dark:text-slate-400">{{ __('Topshiriq yaratilmoqda:') }}</p>
            ...
            <div>
                <label class="block text-sm font-medium mb-2
                              text-slate-700 dark:text-cyan-300">{{ __('Topshiriq Fayli (Ixtiyoriy)') }}</label>
