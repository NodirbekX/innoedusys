...
@section('content')
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-slate-900 dark:text-white">Yangi Oraliq Nazorat yaratish</h1>
        </div>
            ...
            <form action="{{ route('oraliq.store') }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4"
                        class="w-full px-4 py-3 rounded-xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900 text-slate-900 dark:text-white focus:ring-2 focus:ring-cyan-500 transition-all"
                        placeholder="Topshiriq shartlari va ko'rsatmalar..."></textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-slate-400 italic">Umumiy ball 50 dan oshmasligi kerak. (Hozirgi
                            yig'indi: {{ $currentTotal }})</p>
                ...
                <div>
                    <label for="assignment_file"
                        class="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2">Topshiriq fayli (PDF,
                        DOCX, PPTX)</label>
                    <div
