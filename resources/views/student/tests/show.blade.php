    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="text-right">
                <div class="text-sm text-gray-600">{{ __('Remaining Time') }}</div>
            ...
            <form id="exam-form" action="{{ route('student.tests.submit', $test) }}" method="POST">
                ...
                <div class="fixed bottom-0 left-0 right-0 bg-white border-t p-4 shadow-lg text-center">
                    <button type="submit"
                        ...
                        onclick="return confirm('{{ __('Are you sure you want to submit?') }}');">
                        {{ __('Submit Exam') }}
                    </button>
                </div>
    ...
    <script>
        ...
        const timerInterval = setInterval(function () {
            ...
            if (distance < 0) {
                ...
                document.getElementById("timer").innerHTML = @json(__('EXPIRED'));
